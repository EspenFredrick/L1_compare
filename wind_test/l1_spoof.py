...
file1 = pd.read_csv('test_csv/WI_H1_SWE_1933802.csv', delimiter=',', header=0, parse_dates=['Time'])
file2 = pd.read_csv('test_csv/WI_H0_MFI_1933802.csv', delimiter=',', header=0, parse_dates=['Time'])
